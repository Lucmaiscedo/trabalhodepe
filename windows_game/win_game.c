...
{  
    ...
    printf("\nO combate vai comecar, entao se prepare!\n");
    printf("\nsua vida [%d]\n", p1.attribute[0]);
...
void show_texts()
{
    ...
    printf("\n\nDeseja ver a descricao de algum local?  (s/n)\n\n");
    char answer;
    answer = getchar();
...
void tutorial()
{
    ...
    if (answer == '2')
    {
        system("cls");
        printf("\n\nO que deseja fazer?\n\n");
        printf("\nOBS: apos escolher sua opcao, abra o jogo novamente!\n\n");
