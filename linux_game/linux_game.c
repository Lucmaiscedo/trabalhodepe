...
{  
    ...
    if (file == NULL) 
    {
        fprintf(stderr, "Não foi possível abrir o arquivo titulo.txt\n");
        exit(1); 
    }
    ...
    printf("O combate vai começar, então se prepare!\n");
    printf("\nsua vida [%d]\n", p1.attribute[0]);
...
void show_texts()
{
    ...
    printf("\n\nDeseja ver a descrição de algum local?  (s\n)\n\n");
    char answer;
    answer = getchar();
...
void fight()
{
    ...
    switch(i)
    {
        ...
        case (2):
            ...
            printf("A batalha vai começar, então se prepare!\n");
...
void update_save()
{
    ...
    fprintf(file,"Nível[%d]\n", p1.attribute[3]);
    fprintf(file,"Vida [%d]\n", p1.attribute[0]);
    fprintf(file,"Força [%d]\n", p1.attribute[1]);
    ...
    if (p1.inventory[0] >= price)
    {
        ...
        switch(option)
        {
            case 's':
                ...
                {
                p1.inventory[0] -= price; //ele paga o preço pra upar de nivel
...
{   
    ...
    switch (option)
    {
        ...
        case '4':
            ...
            {
                printf("Não há monstros nessas ruínas.\n");
                new_londo();
            }
            else
            {
...
void porta_check (){
    ...
    if (p1.boss[0] == 0 && p1.boss[1] == 0) 
    {
        ...
        printf ("Ambas as tochas em cada lado da porta estão apagadas.\n\n\n");
        printf ("Talvez você devesse voltar aqui em breve.\n");
    ...
    {
        printf ("A sua frente, uma porta de pedra com o dobro da sua altura.\n");
        printf ("A tocha ao lado esquerdo da porta está acesa, ela te traz conforto.\n\n\n");
        printf ("Talvez você devesse voltar aqui em breve.\n");
    ...
    {
        printf ("A sua frente, uma porta de pedra com o dobro da sua altura.\n");
        printf ("A tocha ao lado direito da porta está acesa, ela te deixa triste.\n\n\n");
        printf ("Talvez você devesse voltar aqui em breve.\n");
    ...
    {
        printf ("A sua frente, uma porta de pedra com o dobro da sua altura.\n");
        printf ("Com ambas as tochas acesas, voce sente uma sensação de pavor repentina.\n\n\n");
...
void create_newgame() // função que cria um novo perfil do zero
{
    count = 0;
    inicial = 1;
    ...
    while (count == 0)
    {
        ...
        printf("Deseja confirmar a criação do seu personagem?  (s/n)\n\n");
        char option;
        option = getchar();
        system("clear");
        while (getchar() != '\n'); // Limpar buffer de entrada
        ...
        case 's':
            ...
            //player_savefile();//função que salva o perfil do jogador
            print_prologue();
...
void tutorial()
{
    ...
    if (answer == '2')
    {
        system("clear");
        printf("\n\nO que deseja fazer?\n\n");
        printf("\nOBS: após escolher sua opção, abra o jogo novamente!\n\n");
